...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      var urlApprouved = true;
      (0, _index.UpdateURL)(rlH, rlDH, rlH2);
      (0, _index.GetTitleFromURL)(rlH, function (title) {
        _index.Radio.emit(_index.LOADRULESLISTSANDDETAILS, rlH, rlH2, title);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_index.StaticOverlay, null)
      );
    }
  }]);
...
var SHOWOVERLAY = exports.SHOWOVERLAY = 'ShowOverlayAndAddParametersPassed';
var HIDEOVERLAY = exports.HIDEOVERLAY = 'HideOverlayAndAddVoidParametersPassed';
var LOADRULESLISTSANDDETAILS = exports.LOADRULESLISTSANDDETAILS = 'LOADRULESLISTSANDDETAILS';
...
var Body = function (_React$Component) {
  ...
  function Body(props) {
    ...
    _index.Radio.listen(_index.LOADRULESLIST, function () {
      return _this.setState({ staticUI_cls: 'static-UI hidden' });
    });
    _index.Radio.listen(_index.RETURNTOSTART, function () {
      return _this.setState({ staticUI_cls: 'static-UI' });
    });
    return _this;
  }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: this.state.staticUI_cls },
          _react2.default.createElement(
            'p',
            { className: 'WelcomeTitle' },
            'Welcome to the CAST Structural Rules Portal, let\'s start browsing or searching the rules',
            _react2.default.createElement(
              'span',
              null,
              'BETA'
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'span',
          { className: cn },
          this.prettyPrint(this.props.value)
        )
      );
    }
  }, {
    key: 'prettyPrint',
    value: function prettyPrint(key) {
      return _index.EXTENTIONNAMES[key];
    }
  }, {
    key: 'stylize',
...
/***/ "./qrp_WebApp/src/components/body/searchResultsBlock.js":
/*!**************************************************************!*\
  !*** ./qrp_WebApp/src/components/body/searchResultsBlock.js ***!
  \**************************************************************/
/*! no static exports found */
...
var SearchResultElement = function (_React$Component) {
  _inherits(SearchResultElement, _React$Component);

  function SearchResultElement() {
    _classCallCheck(this, SearchResultElement);

    return _possibleConstructorReturn(this, (SearchResultElement.__proto__ || Object.getPrototypeOf(SearchResultElement)).apply(this, arguments));
  }

  _createClass(SearchResultElement, [{
    key: 'render',
    value: function render() {
      var _this2 = this;

      var technos = this.props.technologies;
      var i = 0;
      return _react2.default.createElement(
        'div',
        ...
        technos ? technos.map(function (t) {
          return _react2.default.createElement(
            'span',
            { key: t.id + i++, onMouseDown: _this2.dispatchAction.bind(_this2, t.href, t.name) },
            t.name
          );
        }) : undefined
      );
    ...
    key: 'dispatchAction',
    value: function dispatchAction(href, name) {
      _index.Radio.emit(_index.LOADRULESLIST, href, name);
...
var Rules = function (_React$Component) {
  ...
  function Rules() {
    ...
    _index.Radio.listen(_index.LOADRULESLISTSANDDETAILS, _this.loadLists.bind(_this));
    return _this;
  }

  _createClass(Rules, [{
    key: 'loadLists',
    value: function loadLists(rulesListUrl, nextRuleList, name) {
      this.setState({
        rulesVisible: true,
        title: name,
    ...
    value: function LoadRuleList(url, name) {
      ...
      _index.Radio.emit(_index.lOADDETAILS);
      (0, _index.UpdateURL)(url);
    }
  }, {
    key: 'render',
    value: function render() {
...
/***/ "./qrp_WebApp/src/components/elements/sources/aip/aip.js":
/*!***************************************************************!*\
  !*** ./qrp_WebApp/src/components/elements/sources/aip/aip.js ***!
  \***************************************************************/
/*! no static exports found */
...
var _versionNamePP = __webpack_require__(/*! ../versionNamePP */ "./qrp_WebApp/src/components/elements/sources/versionNamePP.js");

var _versionNamePP2 = _interopRequireDefault(_versionNamePP);
...
var AIPSources = function (_React$Component) {
  ...
  _createClass(AIPSources, [{
    ...
    value: function onClickHandler(res) {
      ...
      return _index.Radio.emit(_index.SHOWOVERLAY, (0, _index.dynOvlSettings)(menuEls, val, ret[1].length, 'Select one of the following version:'));
    }
  }, {
    ...
    value: function buildOverlayElemnents(data) {
      return _react2.default.createElement(
        _index.Column,
        { key: JSON.stringify(data), width: '20%', textAlign: 'left' },
        data.map(function (e) {
          return _react2.default.createElement(_index.BodyElement, { key: e.id, value: (0, _versionNamePP2.default)(e.name), onclick: function onclick() {
              _index.Radio.emit(_index.LOADRULESLIST, e.href + '/quality-rules', val.concat(' ', e.name));
              _index.Radio.emit(_index.HIDEOVERLAY);
            }, id: e.id });
        })
      );
...
/***/ "./qrp_WebApp/src/components/elements/sources/extentionNames.js":
/*!**********************************************************************!*\
  !*** ./qrp_WebApp/src/components/elements/sources/extentionNames.js ***!
  \**********************************************************************/
/*! no static exports found */
...
var EXTENTIONNAMES = exports.EXTENTIONNAMES = {
  'CAST AIP': 'CAST AIP',
...
var Sources = function (_React$Component) {
  ...
  _createClass(Sources, [{
    ...
    value: function componentDidMount() {
      ...
      _axios2.default.get('rules/extensions.json').then(function (res) {
      ...
      if (this.state.data) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            'Browse the CAST Structural Rules by Sources/Release Versions'
          ),
          _react2.default.createElement(
            _index.BodyBlock,
            null,
    ...
    key: 'loadVersions',
    value: function loadVersions(eData) {
      var _this4 = this;

      _axios2.default.get('rules/extensions?q=' + eData.href).then(function (res) {
        return _this4.onClickHandler(res, eData.name);
      }).catch(function (err) {
        return console.log(err);
      });
    }
    ...
    value: function onClickHandler(res, name) {
      ...
      _index.Radio.emit(_index.SHOWOVERLAY, (0, _index.dynOvlSettings)(menuEls, _index.EXTENTIONNAMES[name], ref.length, 'Select one of the following version:'));
    }
  }, {
    key: 'buildOverlayElemnents',
    value: function buildOverlayElemnents(data, name) {
      return _react2.default.createElement(
        _index.Column,
        { key: JSON.stringify(data), width: '100%', textAlign: 'left' },
        data.map(function (e) {
          return _react2.default.createElement(_index.BodyElement, { key: e.id + name, value: (0, _versionNamePP2.default)(e.name), onclick: function onclick() {
              _index.Radio.emit(_index.LOADRULESLIST, e.href + '/quality-rules', _index.EXTENTIONNAMES[name].concat(' ', (0, _versionNamePP2.default)(e.name)));
              _index.Radio.emit(_index.HIDEOVERLAY);
            }, id: e.id });
        })
      );
...
/***/ "./qrp_WebApp/src/components/elements/sources/versionNamePP.js":
/*!*********************************************************************!*\
  !*** ./qrp_WebApp/src/components/elements/sources/versionNamePP.js ***!
  \*********************************************************************/
/*! no static exports found */
...
exports.default = prettyPrintVersionName;
var map = {
  LTS: '',
...
function prettyPrintVersionName(name) {
  var type = getVersionType(name);
  var strFormat = '{0} {1} {2}';
  var strFormat2 = '{0} {1}';
  var versionArray = name.split('-');
  switch (type) {
    case map.FUNCREL:
...
function getVersionType(name) {
  if (isFuncrel(name)) return map.FUNCREL;else if (isBeta(name)) return map.BETA;else if (isAlpha(name)) return map.ALPHA;else return map.LTS;
}
...
var businessCrit = exports.businessCrit = 'AIP/business-criteria';
var qualityStandards = exports.qualityStandards = 'AIP/quality-standards';
var qualityStandardsCisq = exports.qualityStandardsCisq = 'AIP/quality-standards/CISQ/categories';
var qualityStandardsWASP = exports.qualityStandardsWASP = 'AIP/quality-standards/OWASP/categories';
...
var Standards = function (_React$Component) {
  ...
  function Standards() {
    ...
    return _possibleConstructorReturn(this, (Standards.__proto__ || Object.getPrototypeOf(Standards)).apply(this, arguments));
  }
  ...
  _createClass(Standards, [{
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          [_react2.default.createElement(_index.BodyElement, { key: key++, slideDown: true, value: _elements.CAST, className: 'bodyElement inline casticon', onclick: function onclick() {
              ...
              return (0, _index.APIQuery)(_queries.qualityStandardsCisq, _this2.getCisqStandards.bind(_this2));
              ...
              return (0, _index.APIQuery)(_queries.qualityStandardsWASP, _this2.getOwaspStandards.bind(_this2));
            } })]
        )
      );
    }
    ...
    value: function getCisqStandards(res) {
      ...
      return _index.Radio.emit(_actions.SHOWOVERLAY, (0, _index.dynOvlSettings)(menuEls, 'CISQ Standards', dataList.length, 'Select one of the following category:'));
      //});
    }
  }, {
    key: 'standardizeHrefs',
    value: function standardizeHrefs(data) {
    ...
    value: function getOwaspStandards(res) {
      ...
      //} ),
      menuEls = this.buildSlideDownMenuElements(dataList);
      return _index.Radio.emit(_actions.SHOWOVERLAY, (0, _index.dynOvlSettings)(menuEls, 'OWASP Standards', dataList.length, 'Select one the following Top Ten:'));
      //});
    }
  }, {
    key: 'getCweStandards',
    value: function getCweStandards(res) {
      ...
      (0, _index.APIQuery)(href, function (rr) {
        ...
        return _index.Radio.emit(_actions.SHOWOVERLAY, (0, _index.dynOvlSettings)(menuEls, 'CWE Standards', out.length, 'Select one if the following category:'));
      });
    }
  }, {
    ...
    value: function getBusinessCritera(res) {
      ...
      return _index.Radio.emit(_actions.SHOWOVERLAY, (0, _index.dynOvlSettings)(menuEls, 'Business Criteria', out.length, 'Select one of the following criteria:'));
    }
  }, {
      ...
      return _react2.default.createElement(
        ...
        data.map(function (e) {
          return _react2.default.createElement(_index.BodyElement, { key: e.name + e.id, value: e.name, onclick: function onclick() {
              _index.Radio.emit(_actions.LOADRULESLIST, e.href, e.name);
              _index.Radio.emit(_actions.HIDEOVERLAY);
...
var SectionStandard = exports.SectionStandard = 'Browse the CAST Structural Rules with one of the following standard';
...
var Technologies = function (_React$Component) {
  ...
  _createClass(Technologies, [{
    ...
    value: function componentDidMount() {
      ...
      _axios2.default.get('rules/technologies.json').then(function (res) {
      ...
      if (this.state.data) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            { className: 'bodySection' },
            'Browse the CAST Structural Rules by Technologies'
          ),
          _react2.default.createElement(
            _index.BodyBlock,
            null,
...
var SHOWABOUTQRPORTAL = exports.SHOWABOUTQRPORTAL = 'DisplayAboutQRPortalInOverlay';
...
var Header = function (_React$Component) {
  ...
  function Header(props) {
    ...
    _index.Radio.listen(_index.LOADRULESLIST, function (url, techName) {
    ...
    _index.Radio.listen(_index.LOADRULESLISTSANDDETAILS, function (url, url2, techName) {
      return this.setState({
        backButton: 'visible',
        ruleName: techName
      });
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'menu-icon square30 borderWhite pointerOnHover', onClick: this.loadAbout.bind(this) },
            _react2.default.createElement(
              'div',
          ...
          _react2.default.createElement(
            ...
            this.state.ruleName ? this.state.ruleName : 'CAST Structural Rules'
          )
        ),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('input', { type: 'text', placeholder: 'Search Rules', className: 'searchInput botBorder', ref: 'searchInput', onKeyPress: this.handleInput.bind(this) })
          )
        )
      );
    }
    ...
    value: function handleInput(e) {
      ...
      var key = e.key;
      if (key === 'Enter') {
        (0, _index.Search)(this.refs.searchInput.value, 'qualityrules').then(function (res) {
          return _this2.displaySearchResults(res.data);
        });
    ...
    value: function displaySearchResults(searchResults) {
      var els = this.buildOverlayElemnents(searchResults);
      var resulttitle = '';
      ...
      _index.Radio.emit(_index.SHOWOVERLAY, (0, _index.dynOvlSettings)(els, resulttitle, searchResults.length, 'Select one of the found rules to have more details'));
    }
  }, {
    key: 'buildOverlayElemnents',
    value: function buildOverlayElemnents(data) {
      return _react2.default.createElement(
        _index.Column,
        { key: 0, width: '97%', textAlign: 'left' },
        data.map(function (e) {
          return e.resString.map(function (res, index) {
            return _react2.default.createElement(_index.BodyElement, { key: res + index, value: res, onclick: function onclick() {
    ...
    value: function loadAbout() {
      ...
      var title = 'About CAST Structural Rules';
      _axios2.default.get('about').then(function (res) {
        var aboutContent = _this3.aboutOverlayElements(res.data);
        _index.Radio.emit(_index.SHOWOVERLAY, (0, _index.dynOvlSettings)(aboutContent, title.concat(' ', res.data.version), 50));
      }).catch(function (err) {
        var aboutContent = _react2.default.createElement(
          'p',
          null,
          err
        );
        _index.Radio.emit(_index.SHOWOVERLAY, (0, _index.dynOvlSettings)(aboutContent, title, 50));
      });
    }
  }, {
    key: 'aboutOverlayElements',
    value: function aboutOverlayElements(data) {
      return _react2.default.createElement(
        _index.Column,
        { key: 0, width: '97%', textAlign: 'left', marginBottom: '20px' },
        _react2.default.createElement(
          'h2',
          null,
          'LICENSE'
        ...
        _react2.default.createElement(
          'tr',
          null,
          data.news.map(function (info, idx) {
            return _react2.default.createElement(
              'li',
              { key: idx },
              info
...
var _extentionNames = __webpack_require__(/*! ./elements/sources/extentionNames */ "./qrp_WebApp/src/components/elements/sources/extentionNames.js");

Object.defineProperty(exports, 'EXTENTIONNAMES', {
  enumerable: true,
  get: function get() {
    return _extentionNames.EXTENTIONNAMES;
  }
});

var _main = __webpack_require__(/*! ./overlay/main */ "./qrp_WebApp/src/components/overlay/main.js");

Object.defineProperty(exports, 'StaticOverlay', {
  enumerable: true,
  get: function get() {
...
var _overlay = __webpack_require__(/*! ./overlay/overlay */ "./qrp_WebApp/src/components/overlay/overlay.js");
...
var _roundedContainer = __webpack_require__(/*! ./overlay/roundedContainer */ "./qrp_WebApp/src/components/overlay/roundedContainer.js");

Object.defineProperty(exports, 'OverlayContainer', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_roundedContainer).default;
  }
});

var _layout = __webpack_require__(/*! ./overlay/layout */ "./qrp_WebApp/src/components/overlay/layout.js");
...
var _column = __webpack_require__(/*! ./overlay/column */ "./qrp_WebApp/src/components/overlay/column.js");
...
var _searchResultsBlock = __webpack_require__(/*! ./body/searchResultsBlock */ "./qrp_WebApp/src/components/body/searchResultsBlock.js");

Object.defineProperty(exports, 'SearchResultElement', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_searchResultsBlock).default;
  }
});
...
var _searchQuery = __webpack_require__(/*! ../modules/searchQuery */ "./qrp_WebApp/src/modules/searchQuery.js");

Object.defineProperty(exports, 'Search', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_searchQuery).default;
  }
});

var _urlCategory = __webpack_require__(/*! ../modules/urlCategory */ "./qrp_WebApp/src/modules/urlCategory.js");

Object.defineProperty(exports, 'GetTitleFromURL', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_urlCategory).default;
  }
});
...
Object.defineProperty(exports, 'UNSELECTME2', {
  enumerable: true,
  get: function get() {
    return _actions.UNSELECTME2;
  }
});
...
Object.defineProperty(exports, 'SELECTME2', {
  enumerable: true,
  get: function get() {
    return _actions.SELECTME2;
  }
});
Object.defineProperty(exports, 'LISTLENGTH', {
  enumerable: true,
  get: function get() {
    return _actions.LISTLENGTH;
  }
});
...
Object.defineProperty(exports, 'SHOWOVERLAY', {
  enumerable: true,
  get: function get() {
    return _actions2.SHOWOVERLAY;
  }
});
Object.defineProperty(exports, 'HIDEOVERLAY', {
  enumerable: true,
  get: function get() {
    return _actions2.HIDEOVERLAY;
  }
});
Object.defineProperty(exports, 'LOADRULESLISTSANDDETAILS', {
  enumerable: true,
  get: function get() {
    return _actions2.LOADRULESLISTSANDDETAILS;
  }
});
...
/***/ "./qrp_WebApp/src/components/overlay/column.js":
/*!*****************************************************!*\
  !*** ./qrp_WebApp/src/components/overlay/column.js ***!
  \*****************************************************/
/*! no static exports found */
...
var Column = function (_Component) {
  ...
  _createClass(Column, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'layout-column', style: this.props.styles ? this.props.styles : styles },
        this.props.children
      );
    }
  }]);
...
function dynamicOverlaySettings(children, title, elementCount, sectiontitle, width, bgColor) {
  var heightCalc = elementCount * 34 + 20;
  ...
  _createClass(Layout, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'layoutTitleContainer' },
          _react2.default.createElement(
            'h1',
            { className: 'layoutTitle' },
            this.props.title
          ),
          _react2.default.createElement('button', { className: 'OverlayCloseBtn', type: 'button', onClick: function onClick() {
              return _index.Radio.emit(_index.HIDEOVERLAY);
            } }),
          _react2.default.createElement(
            'p',
...
/***/ "./qrp_WebApp/src/components/overlay/main.js":
/*!***************************************************!*\
  !*** ./qrp_WebApp/src/components/overlay/main.js ***!
  \***************************************************/
/*! no static exports found */
...
var StaticOverlay = function (_React$Component) {
  _inherits(StaticOverlay, _React$Component);

  function StaticOverlay(props) {
    _classCallCheck(this, StaticOverlay);

    var _this = _possibleConstructorReturn(this, (StaticOverlay.__proto__ || Object.getPrototypeOf(StaticOverlay)).call(this, props));
    ...
    _index.Radio.listen(_index.HIDEOVERLAY, resetState.bind(_this));
    return _this;
  }

  _createClass(StaticOverlay, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        _index.Overlay,
        { visible: this.state.visible, height: this.state.height, width: this.state.width, title: this.state.title, sectiontitle: this.state.sectiontitle, backgroundColor: this.state.backgroundColor },
        this.state.children
      );
    }
  }]);
...
exports.default = StaticOverlay;

/***/ }),

/***/ "./qrp_WebApp/src/components/overlay/overlay.js":
/*!******************************************************!*\
  !*** ./qrp_WebApp/src/components/overlay/overlay.js ***!
  \******************************************************/
/*! no static exports found */
...
var Overlay = function (_React$Component) {
  ...
  _createClass(Overlay, [{
    key: 'render',
    value: function render() {
      var visible = this.props.visible ? 'visible' : undefined;
      return _react2.default.createElement(
        'div',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _index.Layout,
            { title: this.props.title, sectiontitle: this.props.sectiontitle },
            this.props.children
          )
        )
      );
...
/***/ "./qrp_WebApp/src/components/overlay/roundedContainer.js":
/*!***************************************************************!*\
  !*** ./qrp_WebApp/src/components/overlay/roundedContainer.js ***!
  \***************************************************************/
/*! no static exports found */
...
var OverlayContainer = function (_React$PureComponent) {
  _inherits(OverlayContainer, _React$PureComponent);

  function OverlayContainer() {
    _classCallCheck(this, OverlayContainer);

    return _possibleConstructorReturn(this, (OverlayContainer.__proto__ || Object.getPrototypeOf(OverlayContainer)).apply(this, arguments));
  }
  ...
  _createClass(OverlayContainer, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'ovlContainer', style: styles },
        _react2.default.createElement(
          'div',
          { className: 'ovl-body' },
          this.props.children
...
var UNSELECTME2 = exports.UNSELECTME2 = 'IfIamSelectedUnselectMeNow2';
var SELECTME = exports.SELECTME = 'IfIamNotSelectedselectMeNow';
var SELECTME2 = exports.SELECTME2 = 'IfIamNotSelectedselectMeNow2';
var LISTLENGTH = exports.LISTLENGTH = 'dispatchlistlengthtotitle';
  ...
  function RulesContainer(props) {
    ...
    _index.Radio.listen(_actions.lOADDETAILS, function (url) {
      ...
      (0, _index.APIQuery)(url, function (res) {
        ...
        (0, _index.UpdateURL)(null, url, null);
  ...
  _createClass(RulesContainer, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_index.RulesList, { href: this.props.href, href2: this.props.href2, isStandard: isStand }),
...
function queryFromTag(tagValue) {
  var url = 'AIP/quality-standards/' + tagValue.standard + '/items/' + tagValue.id + '/quality-rules';
  _index.Radio.emit(_index.LOADRULESLIST, url, tagValue.id);
}
  ...
  _createClass(RuleDetails, [{
    ...
    value: function render() {
      if (this.props.data) {
        ...
        var weightblock = this.props.data.maxWeight ? _react2.default.createElement(
          'div',
          { className: 'weight-container' },
          this.props.data.maxWeight
        ) : '';
...
var RuleListRowElement = function (_React$Component) {
  ...
  function RuleListRowElement(props) {
    ...
    return _possibleConstructorReturn(this, (RuleListRowElement.__proto__ || Object.getPrototypeOf(RuleListRowElement)).call(this, props));
  ...
  _createClass(RuleListRowElement, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'tr',
        { className: localClassName.concat(this.props.selected ? ' selected' : ''), onClick: function onClick() {
  ...
  _createClass(RulesBody, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_index.RulesContainer, { href: this.props.href, href2: this.props.href2 })
      );
    }
  }, {
    key: 'getContainerClass',
...
var RulesList = function (_React$Component) {
  ...
  _createClass(RulesList, [{
    ...
    value: function componentWillReceiveProps(props) {
      ...
      if (props.href && this.props.href !== props.href) {
        (0, _index.APIQuery)(props.href, function (res) {
          ...
          var det = history.state ? history.state.rlDH : undefined;
          var _data = void 0;
          if (det /*&& !props.href2*/) {
              var id = det.substring(18);
              _data = res.data.map(function (e) {
                if (e.id == id) {
                  return Object.assign({}, e, { selected: true });
                } else return Object.assign({}, e, { selected: false });
              });
            }
          _this2.setState({ els: _data || res.data, els2: [] });
        });
      }
      if (props.href2 && this.props.href2 !== props.href2) {
        (0, _index.APIQuery)(props.href2, function (res) {

          var det = history.state ? history.state.rlDH : undefined;

          var els = _this2.state.els.map(function (e) {
          ...
          _this2.setState({ els: els, els2: _data || res.data });
        });
      }
    }
  }, {
    key: 'render',
    value: function render() {
      _index.Radio.emit(_index.LISTLENGTH, this.props.isStandard ? this.state.els.length : this.state.els2.length);
      return this.props.isStandard ? _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.buildListFromState(this.state.els2, this.loadRuleDetails, standardValues, 'els2')
        )
      );
    }
  }, {
    key: 'queryForNextList',
    value: function queryForNextList(url, count) {
      var _this3 = this;
      ...
      if (count === 0) {
        ...
        (0, _index.UpdateURL)(null, null, null);
        this.loadRuleDetails();
      } else {
        (0, _index.APIQuery)(url + '/quality-rules', function (res) {
          _this3.setState(function (_state) {
            return { els: _state.els, els2: res.data };
          });
          (0, _index.UpdateURL)(null, null, url + '/quality-rules');
          _this3.loadRuleDetails();
        });
      }
    }
  }, {
    key: 'buildListFromState',
    value: function buildListFromState(arr, onClickFunction, values, listName) {
      var _this4 = this;

      var key = 0;
      return arr.length === 0 ? _react2.default.createElement(
        'tr',
        null,
        _react2.default.createElement(
          'td',
          { colSpan: '3', key: prefix + key++, style: { textAlign: 'center', paddingTop: '100%' } },
          'No Rules'
        )
      ) : arr.map(function (el, idx) {
        return _react2.default.createElement(_index.RuleListRowElement, { onSelected: function onSelected() {
            return _this4.setSelected(arr, listName, idx);
          }, selected: el.selected, values: values, el: el, key: prefix + key++, onClick: onClickFunction ? function () {
            return onClickFunction(el.href, el.count);
          } : undefined });
      });
    }
  }, {
    ...
    key: 'setSelected',
    value: function setSelected(arr, arrID, index) {
      var _this5 = this;

      return this.setState(function (_state) {
        if (arrID === 'els') {
          return {
            els: _this5.setSelectedInList(arr, index),
            els2: []
          };
        } else {
          return {
            els: _state.els,
            els2: _this5.setSelectedInList(arr, index)
          };
        }
      });
    }
  }, {
    key: 'setSelectedInList',
    value: function setSelectedInList(arr, index) {
...
var RulesTitle = function (_React$Component) {
  ...
  function RulesTitle(props) {
    _classCallCheck(this, RulesTitle);

    var _this = _possibleConstructorReturn(this, (RulesTitle.__proto__ || Object.getPrototypeOf(RulesTitle)).call(this, props));

    _this.state = {};
    _index.Radio.listen(_index.LISTLENGTH, function (len) {
      return _this.setState({ len: len });
    });
    return _this;
  }
...
function APIQuery(dataName, callback, onError) {
  _axios2.default.get(rest + dataName).then(function (res) {
    return callback(res);
  }).catch(function (err) {
    if (onError) onError(err);else console.log(err.stack);
  });
}
...
function isNonStandardList(url) {
  var reg = /\/OWASP\/categories\/|\/CISQ\/categories\/|\/CWE\/categories\//i;
...
/***/ "./qrp_WebApp/src/modules/searchQuery.js":
/*!***********************************************!*\
  !*** ./qrp_WebApp/src/modules/searchQuery.js ***!
  \***********************************************/
/*! no static exports found */
...
function Search(queryString, indexDef) {
  return _axios2.default.get('search/'.concat(indexDef, '/?q=', queryString)).catch(function (err) {
...
/***/ "./qrp_WebApp/src/modules/urlCategory.js":
/*!***********************************************!*\
  !*** ./qrp_WebApp/src/modules/urlCategory.js ***!
  \***********************************************/
/*! no static exports found */
...
exports.default = deriveNameFromURL;

var _urlTypes = __webpack_require__(/*! ./urlTypes */ "./qrp_WebApp/src/modules/urlTypes.js");

var _extentionNames = __webpack_require__(/*! ../components/elements/sources/extentionNames */ "./qrp_WebApp/src/components/elements/sources/extentionNames.js");

var _versionNamePP = __webpack_require__(/*! ../components/elements/sources/versionNamePP */ "./qrp_WebApp/src/components/elements/sources/versionNamePP.js");
...
var technos = 'rules/technologies.json';
var businessCriteriaList = 'rest?q=business-criteria.json';

function deriveNameFromURL(url, callback, errorHandler) {
  if (!url) return;
  var urlType = getUrlType(url);
  switch (urlType) {
    case _urlTypes.TECHNOLOGY:
      return requestAndFilterTechnos(technos, url, callback, errorHandler);
    case _urlTypes.EXTENTION:
      return callback(getNameFromExtentionUrl(url));
    case _urlTypes.BUSINESSCRITERIA:
      return requestAndFilterBC(businessCriteriaList, url, callback, errorHandler);
    case _urlTypes.QUALITYSTANDARD:
      return callback(getNameFromQualityStandardUrl(url));
    case _urlTypes.CASTAIP:
...
function getCastAIPNameFromURL(url) {
  var prefix = 'CAST AIP ';
  var fullversion = getNameFromUrl(url);
  var fullName = prefix + fullversion;
  return fullName.substring(0, fullName.indexOf('_'));
}

function getNameFromQualityStandardUrl(url) {
  var name = url.match(/[^/]+(?=\/items)/i);
  return name;
}

function getNameFromUrl(url) {
  var name = url.match(/[^/]+(?=\/quality-rules)/i);
  return name;
}

function getNameFromExtentionUrl(url) {
  var name = url.substring(32, url.indexOf('/', 32));
  var versionIndex = url.indexOf('/versions/', 32) + 10;
  var version = url.substring(versionIndex, url.indexOf('/', versionIndex));
  return _extentionNames.EXTENTIONNAMES[name] + ' ' + (0, _versionNamePP2.default)(version);
}

function requestAndFilterTechnos(query, url, callback, errorHandler) {
  return _axios2.default.get(query).then(function (res) {
    var data = res.data;
    var element = data.find(function (entry) {
...
function requestAndFilterBC(query, url, callback, errorHandler) {
  return _axios2.default.get(query).then(function (res) {
    var data = res.data;
    var element = data.find(function (entry) {
      return entry.href + '/quality-rules' === url;
    });
    callback(element.name);
  }).catch(function (err) {
    return errorHandler ? errorHandler(err) : console.log(err);
...
function getUrlType(url) {
  if (isBusinessCriteria(url)) return _urlTypes.BUSINESSCRITERIA;else if (isTechnology(url)) return _urlTypes.TECHNOLOGY;else if (isExtention(url)) return _urlTypes.EXTENTION;else if (isQualityStandard(url)) return _urlTypes.QUALITYSTANDARD;else if (isCASTAIP(url)) return _urlTypes.CASTAIP;
}

function isTechnology(url) {
  var reg = /(technologies\/)/i;
  return reg.test(url);
}

function isExtention(url) {
  var reg = /(extensions\/)/i;
  return reg.test(url);
}

function isCASTAIP(url) {
  var reg = /(AIP\/versions\/)/i;
  return reg.test(url);
}

function isBusinessCriteria(url) {
  var reg = /(business-criteria\/)/i;
  return reg.test(url);
}

function isQualityStandard(url) {
  var reg = /(quality-standards\/)/i;
  return reg.test(url);
}

/***/ }),

/***/ "./qrp_WebApp/src/modules/urlTypes.js":
/*!********************************************!*\
  !*** ./qrp_WebApp/src/modules/urlTypes.js ***!
  \********************************************/
/*! no static exports found */
...
var TECHNOLOGY = exports.TECHNOLOGY = 'TECHNOLOGY';
var BUSINESSCRITERIA = exports.BUSINESSCRITERIA = 'BUSINESSCRITERIA';
var EXTENTION = exports.EXTENTION = 'EXTENTION';
var QUALITYSTANDARD = exports.QUALITYSTANDARD = 'QUALITYSTANDARD';
var CASTAIP = exports.CASTAIP = 'CASTAIP';
...
function updateURL(href, detailsHref, href2) {
  ...
  var qStr = nextState.rlH ? ['?' /*, 'rlH', valSeparator, nextState.rlH */] : [];
