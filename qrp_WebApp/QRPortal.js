...
var HIDEOVERLAY = exports.HIDEOVERLAY = 'ShowOverlayAndAddParametersPassed';
...
var Standards = function (_React$Component) {
  ...
  _createClass(Standards, [{
    ...
    value: function getBusinessCritera(res) {
      ...
      return _index.Radio.emit(_actions.SHOWOVERLAY, { children: menuEls });
    }
  }, {
    key: 'determineMenuVisibility',
    value: function determineMenuVisibility(nextScope) {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'span',
              null,
              this.state.ruleName ? '- '.concat(this.state.ruleName.replace(/(%20)/g, ' ')) : undefined
            )
          )
        ),
        _react2.default.createElement(
...
var StaticOverlay = function (_React$Component) {
  ...
  function StaticOverlay(props) {
    ...
    var boundSetState = function boundSetState(state, callback) {
      return _this.setState.bind(_this, state, callback);
    };
    ...
    _index.Radio.listen(_index.HIDEOVERLAY, resetState);

    var resetState = function resetState() {
      return _this.setState({ visible: undefined, children: undefined });
    };
    return _this;
  }
