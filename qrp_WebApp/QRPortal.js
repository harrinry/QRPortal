      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            'Welcome to the CAST Structural Rules Portal, let\'s start broswing or searching the rules',
            _react2.default.createElement(
              'span',
              null,
              'BETA'
...
var Sources = function (_React$Component) {
  ...
  _createClass(Sources, [{
    ...
    value: function onClickHandler(res, name) {
      ...
      _index.Radio.emit(_index.SHOWOVERLAY, (0, _index.dynOvlSettings)(menuEls, name, ref.length, 'Select one of the following version:'));
    }
  }, {
    key: 'buildOverlayElemnents',
  ...
  _createClass(Standards, [{
    ...
    value: function getCisqStandards(res) {
      ...
      (0, _index.APIQuery)(href, function (rr) {
        ...
        return _index.Radio.emit(_actions.SHOWOVERLAY, (0, _index.dynOvlSettings)(menuEls, 'CISQ Standards', out.length, 'Select one of the following category:'));
      });
    }
  }, {
    ...
    value: function getOwaspStandards(res) {
      ...
      (0, _index.APIQuery)(href, function (rr) {
        ...
        return _index.Radio.emit(_actions.SHOWOVERLAY, (0, _index.dynOvlSettings)(menuEls, 'OWASP Standards', out.length, 'Select one the following Top Ten:'));
      });
    }
  }, {
    key: 'getCweStandards',
...
var Header = function (_React$Component) {
  ...
  _createClass(Header, [{
    ...
    value: function buildOverlayElemnents(data) {
      return _react2.default.createElement(
        _index.Column,
        { key: 0, width: '100%', textAlign: 'left' },
        data.map(function (e) {
          return e.resString.map(function (res, index) {
            return _react2.default.createElement(_index.BodyElement, { key: res + index, value: res, onclick: function onclick() {
                _index.Radio.emit(_index.LOADRULESLIST, e.technologies[index].href, e.technologies[index].name);
                _index.Radio.emit(_index.HIDEOVERLAY);
              }, id: e.id });
          });
        })
...
function dynamicOverlaySettings(children, title, elementCount, sectiontitle, width, bgColor) {
  var heightCalc = elementCount * 32 + 20;
...
function queryFromTag(tagValue) {
  var query = 'quality-standards/'.concat(tagValue.standard, '/', tagValue.id, '.json');
  var nameQuery = 'quality-standards/' + tagValue.standard + '.json';
  return (0, _index.APIQuery)(nameQuery, function (resStandards) {
    var standardsData = resStandards.data;
    console.log(standardsData);
    var name = standardsData.find(function (v) {
      return v.href === query;
    });
    console.log(name);
    return _index.Radio.emit(_index.LOADRULESLIST, query, name);
  });
}
        ...
        if (length > 0) {
          tagsblock = _react2.default.createElement(
            ...
            this.props.data.qualityStandards.map(function (listValue) {
              return _react2.default.createElement(
                'li',
                { className: 'detail-tag', onClick: function onClick() {
...
var _filter = __webpack_require__(/*! ../../../serverModules/filter */ "./serverModules/filter.js");
...
*/
function isCPP(id) {
  return _filter2.default.cpp.indexOf(id) === -1 ? false : true;
}
...
function isRPG(id) {
  return _filter2.default.rpg.indexOf(id) === -1 ? false : true;
}
...
function isPLI(id) {
  return _filter2.default.pli.indexOf(id) === -1 ? false : true;
}

function getMSSQLEntries(arr) {
  return arr.filter(function (en) {
    return isMSSQL(en.id);
  });
}

function isMSSQL(id) {
  return _filter2.default.mssql.indexOf(id) === -1 ? false : true;
}
...
function isSAP(id) {
  return _filter2.default.sap.indexOf(id) === -1 ? false : true;
}

function isPure(id) {
  return _filter2.default.all.indexOf(id);
}
  ...
  var filtered = arr.map(function (e) {
    ...
    if (idx !== -1) {
      if (idx < 3 && !cpp) {
        ...
        e.id = _filter2.default.rpg[0];
        e.href = _newHref;
        e.name = 'RPG';
      } else if (idx > 7 && idx <= 9 && !pli) {
        pli = true;
        var _us = getPLIEntries(arr);
        var _urls2 = _us.map(function (a) {
          return a.href;
        });
        var _newHref2 = _multiURLQueryBuilder2.default.apply(undefined, [ID].concat(_toConsumableArray(_urls2)));
        e.id = _filter2.default.pli[0];
        e.href = _newHref2;
        e.name = 'PLI';
      } else if (idx > 9 && idx <= 11 && !mssql) {
        mssql = true;
        var _us2 = getMSSQLEntries(arr);
        var _urls3 = _us2.map(function (a) {
          return a.href;
        });
        var _newHref3 = _multiURLQueryBuilder2.default.apply(undefined, [ID].concat(_toConsumableArray(_urls3)));
        e.id = _filter2.default.mssql[0];
        e.href = _newHref3;
        e.name = 'SQL Server';
      } else if (idx > 11 && idx <= 13 && !sap) {
        sap = true;
        var _us3 = getSAPEntries(arr);
        var _urls4 = _us3.map(function (a) {
          return a.href;
        });
        var _newHref4 = _multiURLQueryBuilder2.default.apply(undefined, [ID].concat(_toConsumableArray(_urls4)));
        e.id = _filter2.default.sap[0];
        e.href = _newHref4;
        e.name = 'SAP';
      } else {
        return;
...
function Search(queryString, indexDef) {
  return _axios2.default.get('search?s='.concat(queryString, '&f=', indexDef)).catch(function (err) {
    return console.log(err.stack);
  });
}
