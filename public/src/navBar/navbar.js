  ...
  render() {
    ...
    return (
      <div className={createClassName('LeftBar', open)}>
        ...
        <div className='Nav'>
          {this.props.children.map( (section, index) => <NavItem key={index} href={section.href} name={section.name} onItemClick={this.props.onItemClick}>{section.children}</NavItem>)}
        </div>
