...
import VerticalArray from '../components/array/index';
import { VIEW_TYPES } from 'view-navigation/vn-constants';
import { compareFunction } from './body-lib';
      ...
      {props.view === NAVIGATION_VIEW || props.view === LANDING_PAGE ? 
        ...
        (<div className={COMMON_CLASSES.width100pc}>
          <div className={CLASSES.listArea}>
            <VerticalArray onEmpty={'No Rules'} headers={['ID','Name', 'Critical']} compare={compareFunction}>
              { props.searchVisible ? (props.searchResults.length === 0 ? [] : props.searchResults) : props.list.content.data}
            </VerticalArray>
